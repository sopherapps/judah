"""
Module containing quarter based export site data source
"""
from typing import Tuple, Iterator, Dict, Any, Optional

from selenium import webdriver

from ..base.quarter_based import QuarterBasedBaseSource
...
class QuarterBasedExportSiteSource(QuarterBasedBaseSource):
    ...
    def _download_file(self, start_quarter_and_year: Tuple[int, int],
                       end_quarter_and_year: Tuple[int, int]) -> str:
    ...
    def _query_data_source(self, start_quarter_and_year: Tuple[int, int],
                           end_quarter_and_year: Tuple[int, int], **kwargs) -> Iterator[Dict[str, Any]]:
        """
        Queries a source given start and end quarter_year tuples
        and returns an iterator with data records
        """
        self._initialize_chrome()
        file_path = self._download_file(start_quarter_and_year=start_quarter_and_year,
                                        end_quarter_and_year=end_quarter_and_year)
